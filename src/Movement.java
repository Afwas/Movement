/**
 * Movement.java
 * This class does the calculation for bridge (card game) movements.
 * The constructor requires 
 * @param int the number of pairs
 * @param int the number of tables or sets of boards
 * @param int the number of rounds
 * Use of the class:
 * You want to crate an object and generate a movement
 * with myMob=vement.generateMovement(); You can then view
 * the results with myMovemenet.showMovement(), which acts as a 
 * sort of toString() method.
 *
 * @author (c) Foppe HEMMINGA - 2011
 * @email foppe@hemminga.net
 * @licence GPL2 or GPL3
 * @date sun 14-08-2011
 */
...
class Movement
{
	...
	/**
	 * Contructor
	 * The constructor makse an object of the class Seed
	 * which is an array with all possible encounters.
	 * THis is the basis of the calculations perfored in 
	 * this class
	 * @param int the number of pairs
	 * @param int the number of tables or sets of boards
	 * @param int the number of rounds
	...
	/**
	 * Method displays a generated movement. ALso used to
	...
	/**
	 * toString method overloaded by calling
	 * showMovement method.
	 */
	...
	private void fillExtraTables()
	{
		...
		for ( int i = 0; i < getRounds(); i += 1 )
		{
			...
			{
				// Three hours of work on this line
				thisTable = ( ( ( j - 2 ) / 2 ) + ( j % 2 ) 
